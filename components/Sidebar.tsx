...
import { Home, User, GraduationCap, Briefcase, Zap, Mail } from 'lucide-react'
...
export default function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      padding: '10px 8px', borderRadius: 20,
      background: 'rgba(6, 9, 18, 0.6)', backdropFilter: 'blur(20px)',
        ...
        return (
          <button
            ...
            style={{
              ...
              background: isActive ? 'rgba(56,189,248,0.18)' : isHovered ? 'rgba(56,189,248,0.1)' : 'transparent',
          ...
          >
            ...
            <div style={{
              ...
              border: '1px solid rgba(56,189,248,0.25)', color: '#e2e8f0',
              fontSize: 12, fontWeight: 600, padding: '5px 12px', borderRadius: 8,
              whiteSpace: 'nowrap', pointerEvents: 'none',
              opacity: isHovered ? 1 : 0, transition: 'all 0.18s ease',
